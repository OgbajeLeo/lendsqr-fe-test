                      ...
                      <li key={item.href}>
                        <Link
                          ...
                          className={`flex items-center gap-3 px-6 py-3 transition-colors ${isActive
                              ? 'bg-[#f3fcfc] text-secondary border-l-4 border-primary'
                              : 'text-[#8b9bba] hover:bg-gray-50 '
                            }`}
                        >
                          <span>{item.icon}</span>
                          <span>{item.name}</span>
                    ...
                    return (
                      <li key={item.href}>
                        <Link
                          href={item.href}
                          className={`flex items-center gap-3 px-6 py-3 transition-colors ${isActive
                              ? 'bg-primary bg-opacity-10 text-secon border-l-4 border-primary'
                              : 'text-[#8b9bba] hover:bg-gray-50 '
                            }`}
                        >
                          <span>{item.icon}</span>
              ...
              <div className="flex items-center gap-2">
                ...
                <button className="text-[#8b9bba]">
                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M9.39229 12.0516C9.72823 12.425 10.2751 12.4219 10.6079 12.0516L13.4829 8.85701C13.8188 8.48435 13.6852 8.18201 13.1845 8.18201H6.81567C6.31489 8.18201 6.18363 8.48747 6.51723 8.85701L9.39229 12.0516Z" fill="#213F7D" />
                  </svg>
